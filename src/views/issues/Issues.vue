<template>
  <div class="shark-data-table">
    <div class="pt-32 mb-32">
      <span class="head-title">Issues</span><br />
      <span class="subtitle">View all the information related to issues</span>
    </div>
    <template>
...
export default {
  ...
  methods: {
    ...
    getPaginatedIssues(filters, sortField, sortDirection, offset, limit,searchQuery) {
