  ...
  <div class="sidebar-container">
    <div class="sidebar-section">
      <span class="header bold"
        >{{this.$route.name === "asset-category-template" ? 'Asset Category Template' : this.$route.name === 'view-assigned-template' ? 'Scheduled Inspection Summary' : 'Inspection Template' }}
      </span>
