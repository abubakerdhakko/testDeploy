...
export default {
  ...
  methods: {
    ...
    restoreArchived() {
      ...
      InspectionService.restoreInspection(this.inspectionID)
        .then((res) => {
          if (res.status == 200) {
            this.loaderFlag = false;
            this.$emit(
              "showToast",
              "Restored Inspection Successfully",
              "success"
            );
    ...
    loadTable(sdtData) {
      ...
      this.getPaginatedArchivedInspections(
        filters,
    ...
    getPaginatedArchivedInspections(
      filters,
      sortField,
      sortDirection,
      offset,
      ...
      InspectionService.getPaginatedArchivedInspectionsForSDT(requestObj)
        .then((response) => {
          if (response.status == 200) {
